        ...
        <YStack flex={1} paddingTop={24} paddingHorizontal={10}>
          <ScrollView flex={1} showsVerticalScrollIndicator={false}>
            ...
            <YStack gap={8}>
              <XStack height={20}>
                <Text>{' * '}</Text>
                <SettingGroupTitle>{t('settings.models.default_assistant.hint.name')}</SettingGroupTitle>
              </XStack>

              <XStack paddingVertical={8} gap={8} position="relative">
                <Input
                  flex={1}
                  placeholder={t('settings.models.default_assistant.hint.placeholder')}
                  value={assistantName}
              ...
              <XStack height={20}>
                <SettingGroupTitle>{t('settings.models.default_assistant.hint.prompt')}</SettingGroupTitle>
              </XStack>
              ...
              <XStack height={20}>
                <SettingGroupTitle>{t('settings.models.default_assistant.hint.params')}</SettingGroupTitle>
              </XStack>
